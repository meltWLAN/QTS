...
class CosmicEnergyVisualization(QWidget):
        ...
        for node in self.nodes:
            ...
            for connection in node.connections:
                ...
                if random.random() < 0.3 * self.energy_level:
                    ...
                    painter.drawEllipse(QRectF(px - pulse_size, py - pulse_size, pulse_size * 2, pulse_size * 2))
    ...
    def draw_nodes(self, painter):
        ...
        for node in self.nodes:
            ...
            painter.setBrush(QBrush(radial))
            painter.setPen(Qt.NoPen)
            painter.drawEllipse(QRectF(x - pulse_size * 1.5, y - pulse_size * 1.5, pulse_size * 3, pulse_size * 3))
            ...
            painter.drawEllipse(QRectF(x - pulse_size, y - pulse_size, pulse_size * 2, pulse_size * 2))
    ...
    def draw_particles(self, painter):
        ...
        for particle in self.particles:
            ...
            # 绘制粒子
            painter.drawEllipse(
                QRectF(particle.x - particle.size, particle.y - particle.size, 
