...
class DashboardPanel(QWidget):
    ...
    def _on_resources_updated(self, resources):
        ...
        # 使用正确的方式调用UI更新方法，确保在主线程执行
        QMetaObject.invokeMethod(self, "_update_displays", Qt.QueuedConnection)
    ...
    def _update_displays(self):
        ...
        try:
            ...
            # 更新系统组件总体使用率
            component_usage = resources.get('component_usage', 0)
            self.component_meter.set_value(component_usage)
            ...
            logging.getLogger("QuantumDesktop.DashboardPanel").error(f"更新显示错误: {str(e)}") 